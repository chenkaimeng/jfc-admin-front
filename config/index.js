...
config.set('globals', {
  ...
  'PUBLIC_PATH'  : PUBLIC_PATH[config.get('env')],  // config.get('env') === 'production' ? 'https://static.aixuehuisi.cn/static/editor/' : '/',
  '__DEV__'      : config.get('env') === 'local',
